...
class VocabDbAccessTest extends PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
        ...
        $this->dbHandler = new VocabDbAccess(true); // true = set test mode.
    }
    ...
    public function testInsertVocab() {
        ...
        $this->assertTrue($this->dbHandler->insertVocab(array($vocab))); // worked
        //
        // now we know, that the db is not empty. (max index +=1)
        $vocab2 = new Vocab("easy", "adjective", array(
            "leicht", "einfach", "leichtfällig"));
